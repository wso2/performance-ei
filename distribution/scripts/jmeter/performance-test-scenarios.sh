...
declare -A test_scenario1=(
    ...
    [description]="Routing message by reading a text field in message body"
...
declare -A test_scenario2=(
    ...
    [description]="Routing message by reading a SOAP header in message payload"
...
declare -A test_scenario3=(
    ...
    [description]="Reading transport header and route to backend"
